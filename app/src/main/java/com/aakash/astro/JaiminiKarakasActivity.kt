...
class JaiminiKarakasActivity : AppCompatActivity() {
    ...
    private fun createHighlightChip(text: String): Chip {
        return Chip(this).apply {
            ...
            chipIcon = ContextCompat.getDrawable(context, R.drawable.ic_chip_star)
            chipIconTint = android.content.res.ColorStateList.valueOf(getColor(R.color.accent_teal))
        }
    }
